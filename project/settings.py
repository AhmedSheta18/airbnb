...
SECRET_KEY = 'django-insecure-a(vg0@nq_)#%3&$iuly!!2^njf&c84+_we1qk3v$g5yh_e2)nr'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'settings.footer_context_processor.footer_context',  # Custom context processor for footer settings
            ],
        },
    },
]
